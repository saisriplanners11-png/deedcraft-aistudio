...
const party = (side: 'executant' | 'claimant'): Field[] => {
  ...
  return [
    ...
    { id: k('Age'), label: 'Age', ph: `${P} Age`, type: 'number', hint: 'Worked out from the date of birth, as on the date of execution' },
    ...
    { id: k('Pan'), label: 'PAN', hint: 'Required above ₹50 lakh' },
...
export const GROUPS: Group[] = [
  ...
  },
  {
    ...
    note: 'What is being conveyed. The fields shown follow the category chosen in Step 01.',
    fields: [
      { id: 'plotNo', label: 'Plot number', ph: 'Plot No.' },
      { id: 'extentSqYards', label: 'Extent (Sq. Yards)', ph: 'Extent in Sq.yards', type: 'number',
        hint: 'Exact extent printed in the uploaded property document, or typed directly.' },
      { id: 'extentSqMeters', label: 'Extent (Sq. Meters)', ph: 'Extent in Sq.Meters', type: 'number',
        hint: 'Worked out automatically from Extent (Sq. Yards); typed over only when a different figure is printed in the source document.' },
      ...
      { id: 'extentValue', label: 'Extent (other unit)', type: 'number', hidden: true },
    ],
  },
  {
    step: 3,
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'natureOfHouse', label: 'Nature of roof', ph: ['Nature of House', 'Nature Of House'], only: HOUSE_CATEGORIES, hint: 'e.g. RCC, Madras terrace' },
      { id: 'floors', label: 'Floors', ph: 'Floors', only: HOUSE_CATEGORIES },
      { id: 'ageOfHouse', label: 'Age of the house (years)', ph: 'Age of House', type: 'number', only: HOUSE_CATEGORIES },
      { id: 'plinthArea', label: 'Built-up area (Sq. Ft.)', ph: 'Plinth Area', type: 'number', only: HOUSE_CATEGORIES },
      { id: 'bltNo', label: 'Property Tax Identification No.', ph: 'BLT No.', span: 2, only: HOUSE_CATEGORIES },
...
export const LINK_OPTIONS: LinkOption[] = [
  {
    ...
    fields: [
      ...
      { id: 'linkDocDate', label: 'Link deed execution date', ph: 'Link Doct.Date', type: 'date',
        hint: 'The date this document was executed, shown in its opening recital on the first page — not the SRO registration/presentation date.' },
      { id: 'linkSro', label: 'Sub-Registrar Office', ph: ['Sub Registrar', 'Sub-Registrar'], span: 2 },
      { id: 'linkSroCode', label: 'SRO code', hint: 'Filled in automatically from the Sub-Registrar Office entered in the Jurisdiction step; only type over it if this document names a different SRO code.' },
    ],
  },
  {
    id: 'houseTax', label: 'House Tax Receipt No.', telugu: 'ఇంటి పన్ను రసీదు',
    note: 'Municipal house-tax record. Not part of the template’s fixed clauses — recorded here for reference only.',
    fields: [
      { id: 'houseTaxReceiptNo', label: 'House tax receipt number' },
      { id: 'assessmentPtinNo', label: 'Assessment / PTIN number' },
      { id: 'localBodyName', label: 'Local body', hint: 'Municipality / Gram Panchayat / GHMC circle' },
      { id: 'taxPaidDate', label: 'Tax paid date', type: 'date' },
    ],
  },
  {
    id: 'titleDeed', label: 'Title Deed No.', telugu: 'పట్టాదారు పాస్ పుస్తకం',
    note: 'Pattadar passbook / title-deed record. Not part of the template’s fixed clauses — recorded here for reference only.',
    fields: [
      { id: 'titleDeedNo', label: 'Title deed number' },
      { id: 'khataNo', label: 'Khata number' },
    ],
  },
  {
    id: 'nala', label: 'Nala Order No.', telugu: 'నాలా ఉత్తర్వు',
    note: 'Non-agricultural land-use conversion order. Not part of the template’s fixed clauses — recorded here for reference only.',
    fields: [
      { id: 'nalaOrderNo', label: 'NALA order number' },
      { id: 'nalaProceedingDate', label: 'Proceeding date', type: 'date' },
  ...
  },
  {
    ...
    note: 'Layout, building or regulatory approvals. Not part of the template’s fixed clauses — recorded here for reference only.',
    fields: [
      { id: 'dtcpLayoutApprovalNo', label: 'DTCP Layout Approval' },
      { id: 'lrsApplication2020No', label: 'LRS Application-2020' },
      { id: 'lrsProceedingsNo', label: 'LRS Proceedings' },
      { id: 'hmdaLayoutApprovalNo', label: 'HMDA Layout Approval' },
      { id: 'ghmcApprovalNo', label: 'GHMC Approval' },
      { id: 'municipalityApprovalNo', label: 'Municipality Approval' },
      { id: 'municipalCorporationApprovalNo', label: 'Municipal Corporation Approval' },
      { id: 'grampanchayatApprovalNo', label: 'Grampanchayat Approval' },
      { id: 'permBuildingPermitNo', label: 'Building Permission' },
      { id: 'occupancyCertNo', label: 'Occupancy Certificate (OC)' },
      { id: 'landUseCertNo', label: 'Land Use Certificate' },
      { id: 'cluChangeOfLandUseNo', label: 'CLU – Change of Land Use' },
      { id: 'reraRegNo', label: 'RERA Registration', hint: 'Real Estate Regulatory Authority registration for the project — commonly required for apartment sales.' },
      { id: 'fireNocNo', label: 'Fire NOC' },
      { id: 'irrigationNocNo', label: 'Irrigation NOC' },
    ],
  },
];
